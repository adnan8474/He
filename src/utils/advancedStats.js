 ...
 * statistics required for EQAlert's core functionality. They are intentionally
 ...
 * This helper mirrors the implementation in stats.js but is replicated
...
export function sampleStandardDeviation(values) {
  ...
  const variance = values
    ...
    .reduce((a, b) => a + b, 0) / (values.length - 1);
...
export function blandAltmanFromArrays(a, b) {
  ...
  // Sample standard deviation (n - 1) as recommended for Bland-Altman
