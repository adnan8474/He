/**
 * Utility helpers to export data from POCSTAT.
...
export async function exportElementPDF(element, filename, opts = {}) {
  ...
  if (opts.logo !== false) {
    ...
    doc.addImage(logo, 'PNG', pageWidth - 60, pageHeight - 60, 40, 40);
  }
...
export function exportComparisonCSV(comparison) {
  ...
  const prefix = 'POCSTAT Statistical Report,Generated by POCTIFY LTD\n';
